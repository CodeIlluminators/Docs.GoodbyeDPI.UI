		...
		<div className="w-full mx-auto flex flex-col gap-1 sm:min-h-[91vh] min-h-[88vh] pt-2">
			<div className="mb-7 flex flex-col gap-2">
				...
				<p className="text-muted-foreground relative">
					Последние новости и материалы опубликованные нашей командой. Мы
					стараемся следить за актуальностью ленты, благодарим за любую{' '}
					<Link
						href="https://github.com/Storik4pro/GoodbyeDPI-UI/discussions/"
						target="_blank"
						className="inline underline underline-offset-4"
					>
						обратную связь
						<MoveUpRightIcon className="inline w-4 h-4 font-extrabold" />
					</Link>
