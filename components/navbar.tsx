...
export function Navbar() {
	return (
		<nav className="w-full border-b h-16 overflow-hidden sticky top-0 z-50 backdrop-filter backdrop-blur-xl bg-opacity-5">
...
export const LogoIcon = ({
	...
	return (
		...
		>
			...
			/>
			<path
				d="M166.37,92.33c-2.41-.39-32.56,28.44-32.66,30.4s11.6,14.48,13.42,14.8,31.18-27.13,31.39-29.44S168.44,92.67,166.37,92.33Z"
				style={{
					fill: '#ffe10a',
					stroke: '#e6c800',
					strokeLinecap: 'round',
...
export function Logo() {
	return (
		<Link href="/" className="flex items-center gap-2.5 select-none">
			...
			<h2 className={`text-md font-bold ${GeistMono.variable}`}>
				GoodbyeDPI.UI
			</h2>
		</Link>
	);
